...
umh_step8_2 :                  /* UMH 3. Uneven Multi-Hexagon-grid Search （不规律六边形模板搜索） */
        // g_me_time[3]++;
        dir = 0;                                        /*   6   5   */
        omx = bmx;                                      /*           */
        omy = bmy;                                      /* 1   *   4 */
...
umh_step8_3:                   /* UMH 5. the third step with a small search pattern （小菱形模板反复搜索） */
        dir = 0;
        if (CHECK_MV_RANGE(bmx, bmy)) {
            omx = bmx;                                          /*    4    */
            omy = bmy;                                          /*  1 * 3  */
...
_me_error8:
    ...
    case XAVS2_ME_UMH:        /* UMH */
        ...
        /* !!! NO break statement here */
    case XAVS2_ME_HEX:        /* hexagon search */
umh_step10_2 :                  /* UMH 3. Uneven Multi-Hexagon-grid Search （不规律六边形模板搜索） */
        // g_me_time[3]++;
        dir = 0;                                        /*   6   5   */
        omx = bmx;                                      /*           */
        omy = bmy;                                      /* 1   *   4 */
        ...
        /* !!! NO break statement here */
    case XAVS2_ME_DIA:        /* diamond search */
umh_step10_3:                   /* UMH 5. the third step with a small search pattern （小菱形模板反复搜索） */
        dir = 0;
        if (CHECK_MV_RANGE(bmx, bmy)) {
            omx = bmx;                                          /*    4    */
            omy = bmy;                                          /*  1 * 3  */
