 ...
 */
static
void sao_block_eo_0_c(xavs2_t *h, pel_t *p_dst, int i_dst,
 ...
 */
static
void sao_block_eo_90_c(xavs2_t *h, pel_t *p_dst, int i_dst,
                       const pel_t *p_src, int i_src,
                       int i_block_w, int i_block_h,
                       const int *lcu_avail, const int *sao_offset)
{
 ...
 */
static
void sao_block_eo_135_c(xavs2_t *h, pel_t *p_dst, int i_dst,
                        const pel_t *p_src, int i_src,
                        int i_block_w, int i_block_h,
                        const int *lcu_avail, const int *sao_offset)
{
 ...
 */
static
void sao_block_eo_45_c(xavs2_t *h, pel_t *p_dst, int i_dst,
                       const pel_t *p_src, int i_src,
                       int i_block_w, int i_block_h,
                       const int *lcu_avail, const int *sao_offset)
{
 ...
 */
static
void sao_block_bo_c(xavs2_t *h, pel_t *p_dst, int i_dst,
                    const pel_t *p_src, int i_src,
                    int i_block_w, int i_block_h,
                    const SAOBlkParam *sao_param)
{
    const int max_pel_val = (1 << h->param->input_sample_bit_depth) - 1;
    ...
    const int band_shift = h->param->input_sample_bit_depth - NUM_SAO_BO_CLASSES_IN_BIT;
...
#else
    pf->sao_block_bo                   = sao_block_bo_c;
    pf->sao_filter_eo[SAO_TYPE_EO_0]   = sao_block_eo_0_c;
    pf->sao_filter_eo[SAO_TYPE_EO_45]  = sao_block_eo_45_c;
    pf->sao_filter_eo[SAO_TYPE_EO_90]  = sao_block_eo_90_c;
    pf->sao_filter_eo[SAO_TYPE_EO_135] = sao_block_eo_135_c;
#endif
#if HAVE_MMX
...
#else
        pf->sao_block_bo = SAO_on_block_bo_sse128;
        pf->sao_filter_eo[SAO_TYPE_EO_0] = SAO_on_block_eo_0_sse128;
        pf->sao_filter_eo[SAO_TYPE_EO_45] = SAO_on_block_eo_45_sse128;
        pf->sao_filter_eo[SAO_TYPE_EO_90] = SAO_on_block_eo_90_sse128;
        pf->sao_filter_eo[SAO_TYPE_EO_135] = SAO_on_block_eo_135_sse128;
#endif
    }
#ifdef _MSC_VER
